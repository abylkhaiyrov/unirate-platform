...
public class ForumController {
     ...
     */
    @GetMapping("/search")
    public List<ForumDto> searchForumsByName(@RequestParam Long universityId,@RequestParam String name) {
        return forumService.searchForumsByName(universityId, name);
    }
